...
class TestModel(unittest.TestCase):
    ...
    def test_address(self):
        ...
        address_01 = [['Sheet1!A1', 'Sheet1!A2', 'Sheet1!A3', 'Sheet1!A4', 'Sheet1!A5'],
                    ['Sheet1!C1', 'Sheet1!C2', 'Sheet1!C3', 'Sheet1!C4', 'Sheet1!C5'],
                    ['Sheet1!E1', 'Sheet1!E2', 'Sheet1!E3', 'Sheet1!E4', 'Sheet1!E5']
                    ]
        self.assertEqual(address_01, xlrange_01.address)

        xlrange_02 = XLRange('Sheet1!A1:A5, Sheet1!C1:C5, Sheet1!E1:E5', 'Sheet1!A1:A5, Sheet1!C1:C5, Sheet1!E1:E5')
        address_02 = [['Sheet1!A1', 'Sheet1!A2', 'Sheet1!A3', 'Sheet1!A4', 'Sheet1!A5'],
                    ['Sheet1!C1', 'Sheet1!C2', 'Sheet1!C3', 'Sheet1!C4', 'Sheet1!C5'],
                    ['Sheet1!E1', 'Sheet1!E2', 'Sheet1!E3', 'Sheet1!E4', 'Sheet1!E5']
                    ]
        self.assertEqual(address_02, xlrange_02.address)

        xlrange_03 = XLRange('Sheet1!A1:A5,C1:C5,E1:E5', 'Sheet1!A1:A5,C1:C5,E1:E5')
        address_03 = [['Sheet1!A1', 'Sheet1!A2', 'Sheet1!A3', 'Sheet1!A4', 'Sheet1!A5'],
                    ['Sheet1!C1', 'Sheet1!C2', 'Sheet1!C3', 'Sheet1!C4', 'Sheet1!C5'],
                    ['Sheet1!E1', 'Sheet1!E2', 'Sheet1!E3', 'Sheet1!E4', 'Sheet1!E5']
                    ]
        ...
        address_04 = [['Sheet1!A1', 'Sheet1!A2', 'Sheet1!A3', 'Sheet1!A4', 'Sheet1!A5'],
                    ['Sheet1!B1', 'Sheet1!B2', 'Sheet1!B3', 'Sheet1!B4', 'Sheet1!B5'],
                    ['Sheet1!C1', 'Sheet1!C2', 'Sheet1!C3', 'Sheet1!C4', 'Sheet1!C5']
                    ]
