...
class Countifs(XlCalculatorBaseFunction):
    """"""
    ...
    def countifs(self, *args):
        ...
        if l >= 2:
            indexes = XlCalculatorBaseFunction.find_corresponding_index(args[0].values, args[1]) # find indexes that match first layer of countif
